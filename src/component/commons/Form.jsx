...
const Form = () => {
    ...
    return (
        ...
        <form action="https://sheetdb.io/api/v1/s97k1f7xlof2p" method="post"
            id="sheetdb-form" className="bg-secondary pt-24 pb-44">
            <div className="flex lg:flex-row flex-col justify-center gap-10 max-w-6xl m-auto p-5">
                ...
                <div className="bg-white lg:w-1/2 w-full lg:p-16 p-7">
                    <input type="text" ref={NameRef} id="input" placeholder="Name" name="data[Name]" required />
                    <input type="email" ref={EmailRef} id="input" placeholder="Email" name="data[Email]" required />
                    <input type="text" ref={PhoneNumberRef} id="input" placeholder="Phone Number" name="data[Phone]" required />
                    <textarea className="w-full outline-none border-b border-black mt-5 " ref={MessageRef} name="data[message]" id="" cols="20" rows="10" placeholder="Message" required></textarea>
